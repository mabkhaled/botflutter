...
def main():
    ...
    copyfile("assest//splash.png","flutter_docker//android//app//src//main//res//drawable-v21//ic_launcher.png")
    copyfile("assest//splash.png","flutter_docker//android//app//src//main//res//drawable//ic_launcher.png")
    ...
    #generating a scaffold when the sign in button is pressed in Loin_Screen.dart
        ...
        copyfile("assest//generated_app_template.dart",path_to_file)
