...
if __name__ == "__main__":   
    ...
    bot = tb.TeleBot("1878140208:AAHwwWbL0c3QkhcYfXhhbkbG7E7pyEonYLc", parse_mode=None) # You can set parse_mode by default. HTML or MARKDOWN
    print("------bot started------")
    ############################
...
############
    ...
    def generate_the_app(message):
        ...
        client = pymongo.MongoClient('mongodb+srv://aymen:aymen123@mycluster.hgvjo.mongodb.net/test?retryWrites=true&w=majority')
        ...
        bot.reply_to(message,"""
The app data has been pushed to the cloud i will be generating an app for you !
        """)
...
############
    ...
    def handle_images(message):
        ...
        if CONFIG[7] and CONFIG[4]!=0:
            ...
            image_name="assest/image"+str(CONFIG[9])+".jpg"
